...
export default function AdminTrailersPage() {
  ...
  const trailers = useQuery(api.fleet.getTrailers, { search, sortBy, sortDir }) || [];
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await createTrailer({
        ...
        trailerFleetNoStr: newTrailer.trailerFleetNoStr || undefined,
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-gray-200">
          {/* New row */}
          <div className="grid grid-cols-[repeat(7,minmax(0,1fr))] gap-2 px-3 py-2 text-xs items-center bg-blue-50/50">
          ...
          {trailers.map((t: any, index: number) => {
            ...
            return (
              <div key={uniqueKey} className="grid grid-cols-[repeat(7,minmax(0,1fr))] gap-2 px-3 py-2 text-xs items-center">
                {isEditing ? (
                  <>
