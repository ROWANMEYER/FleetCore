...
export default function AdminTrucksPage() {
  ...
  const trucks = useQuery(api.fleet.getTrucks, { search, sortBy, sortDir }) || [];
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setNewTruck({ truckFleetNo: "", registration: "", make: "", model: "" });
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
        <div className="grid grid-cols-[repeat(6,minmax(0,1fr))] gap-2 bg-gray-50 px-3 py-2 border-b text-[10px] font-semibold text-gray-500 uppercase tracking-wider items-center">
        ...
        <div className="divide-y divide-gray-200">
          {/* New row */}
          <div className="grid grid-cols-[repeat(6,minmax(0,1fr))] gap-2 px-3 py-2 text-xs items-center">
            <input
          ...
          {trucks.map((t: any) => {
            ...
            return (
              <div key={t._id} className="grid grid-cols-[repeat(6,minmax(0,1fr))] gap-2 px-3 py-2 text-xs items-center">
                {isEditing ? (
                  <>
