      ...
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex gap-6 text-sm font-medium">
          <Link
            ...
            className={`hover:text-gray-300 transition-colors ${isActive('/operations/dashboard') ? 'text-white border-b-2 border-white pb-1' : 'text-gray-400'}`}
          >
            Dashboards
          </Link>
          ...
          <Link
            href="/people/drivers"
            className={`hover:text-gray-300 transition-colors ${isActive('/people') ? 'text-white border-b-2 border-white pb-1' : 'text-gray-400'}`}
          >
            People
          </Link>
